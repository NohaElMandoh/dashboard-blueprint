...
<html lang="en">
  <head>
    ...
    <title>Vendor Dashboard Registration</title>
    <!-- plugins:css -->
            ...
            <div class="col-lg-4 mx-auto">
              <div class="auth-form-light text-left p-5">
                <div class="brand-logo">
                  <i class="mdi mdi-view-dashboard" style="color: green;font-weight: 800;">  <span>Register for Dashboard</span></i>
                </div>
                <h4>Hello! Welcome</h4>
                <h6 class="font-weight-light">Sign up to get started.</h6>
                <form class="pt-3" method="POST" action="{{ route('vendor.register.submit') }}">
                  @csrf
