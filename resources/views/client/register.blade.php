            ...
            <div class="col-lg-4 mx-auto">
              <div class="auth-form-light text-left p-5">
                <div class="brand-logo">
                  <i class="mdi mdi-view-dashboard" style="color: green;font-weight: 800;">  <span>Register As Client</span></i>
                </div>
                <h4>Hello! Welcome</h4>
                <h6 class="font-weight-light">Sign up to get started.</h6>
                <form class="pt-3" method="POST" action="{{ route('client.register.submit') }}">
                  @csrf
